        ...
        <div className="bg-[#f8faef] p-10 md:p-20 flex flex-col md:flex-row justify-between">
          ...
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="mt-6">
              ...
              <p className="text-gray-700">Mile2 Nkwen, Bamenda</p>
              <p className="text-gray-700">(237) 650 266 17</p>
              <p className="text-gray-700">(237) 677 578 349</p>
            </div>
